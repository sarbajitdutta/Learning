<!DOCTYPE html>
<%@page import="com.psegli.customersearchportal.config.ConfigurationParam"%>
	...
	<div id="messageElm"></div>
		...
		<div class="menuWrapper">
			<div class="TopMenu">				
                ...
                <span class="LinkList">
                <a class="dropDownActivator" dropDownName="menu_1" href="<%=ConfigurationParam.emailNotification%>"  parent="0">Email Notification&nbsp;</a></span>
                <%}else {}%>
